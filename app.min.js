$(window).on("load", function () {
    ...
    a.isotope({ filter: "*", layoutMode: "masonry", animationOptions: { duration: 750, easing: "linear" } }),
        t.find("a").click(function () {
            ...
            return t.find("a").removeClass("active"), $(this).addClass("active"), a.isotope({ filter: i, animationOptions: { animationDuration: 750, easing: "linear", queue: !1 } }), !1;
        });
});
$(window).on("load", function () {
var a = 0;
...
particlesJS("home", {
    ...
    retina_detect: !0,
    config_demo: { hide_card: !1, background_color: "#b61924", background_image: "", background_position: "50% 50%", background_repeat: "no-repeat", background_size: "cover" },
});
!(function (t) {
    "use strict";
    t(window).scroll(function () {
        50 <= t(window).scrollTop() ? t(".sticky").addClass("nav-sticky") : t(".sticky").removeClass("nav-sticky");
    }),
        t(".navbar-nav a").on("click", function (a) {
            var e = t(this);
            t("html, body")
                .stop()
                .animate({ scrollTop: +t(e.attr("href")).offset().top }, 1500, "easeInOutExpo"),
                a.preventDefault();
        }),
        t("#navbarCollapse").scrollspy({ offset: 70 }),
        t(".mfp-image").magnificPopup({ type: "image", closeOnContentClick: !0, mainClass: "mfp-fade", gallery: { enabled: !0, navigateByImgClick: !0, preload: [0, 1] } });
})(jQuery);
$("#contact-form").submit(function () {
    $(this).attr("action");
    return (
        $("#message").slideUp(750, function () {
            $("#message").hide(), $("#submit").before("").attr("disabled", "disabled");
        }),
        !1
    );
});
